...
while($row1 = mysqli_fetch_array($resulta))
  ...
  */
  $position = addslashes( $_POST['position'] );
    ...
    $results = mysqli_query($con, "SELECT * FROM tbCandidates, tbpositions where candidate_positionId = position_id AND position_name ='$position'");
...
<html><head>
<link href="../admin/css/admin_styles.css" rel="stylesheet" type="text/css" />
<script language="JavaScript" src="../admin/js/admin.js">
</script>
...
<form name="fmNames" id="fmNames" method="post" action="candidaterefresh.php" onSubmit="return positionValidate(this)">
<tr>
