...
$positionIdQuery = mysqli_query($con, "SELECT position_id FROM tbpositions WHERE position_name = '$newCandidatePosition");
$positionIdQueryResult = mysqli_fetch_array($positionIdQuery);
$newCandidatePositionId = $positionIdQueryResult['position_id'];

$newCandidateEmail = addslashes( $_POST['email'] ); //prevents types of SQL injection

$newCandidatePassword = addslashes( $_POST['password'] ); //prevents types of SQL injection

$sql = mysqli_query($con, "INSERT INTO tbCandidates(candidate_name,candidate_positionId, candidate_email, candidate_password) VALUES ('$newCandidateName','$newCandidatePositionId','$newCandidateEmail','$newCandidatePassword')" );
...
<tr>
    ...
    <td><input type="text" name="password" value="temp"/></td>
</tr>
<tr>
