...
// check if Submit is set in POST
 ...
 $result = mysqli_query($con,"SELECT candidate_name, candidate_party, candidate_speech FROM tbCandidates, tbpositions WHERE candidate_positionId = position_id AND position_name='$position'");
...
echo "<tr>";
echo "<td>" . $row['candidate_name']. "\n (". $row['candidate_party'] . ") \n" . $row['candidate_speech'] ."</td>";
